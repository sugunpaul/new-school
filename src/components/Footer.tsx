        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-6">
              Nurturing young minds and fostering a love of learning in a safe, supportive environment.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'About Us', 'Programs', 'Curriculum', 'Contact'].map((item) => (
                <li key={item}>
                  <a 
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <Phone size={18} className="text-preschool-coral mr-3 mt-1 flex-shrink-0" />
                <div>
              ...
              <li className="flex items-start">
                <Mail size={18} className="text-preschool-coral mr-3 mt-1 flex-shrink-0" />
                <div>
              ...
              <li className="flex items-start">
                <svg className="w-5 h-5 text-preschool-coral mr-3 mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} FirstStep Pre School. All rights reserved.
            </p>
