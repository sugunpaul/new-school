...
const ContactSection = () => {
  return (
    <section
      id="contact"
      className="bg-preschool-light-blue py-24 overflow-hidden"
    >
      <div className="section-container relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            We'd love to hear from you! Schedule a visit or get more information
            about our programs.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-transform duration-500 hover:scale-105 hover:shadow-xl">
            <div className="p-6">
              ...
              <button className="block w-full text-center py-3 px-6 bg-preschool-green text-white rounded-lg hover:bg-preschool-green/90 transition-colors duration-300">
                Schedule a Tour
              </button>
            </div>
          </div>
            ...
            <div className="bg-gray-200 h-72 md:h-auto">
              ...
              <div className="h-full flex items-center justify-center bg-preschool-light-blue">
                <div className="text-center">
                  <MapPin
                    size={48}
                    className="text-preschool-blue mx-auto mb-4"
                  />
                  <p className="text-preschool-blue font-medium">
                    Map Placeholder
                  </p>
                  <p className="text-sm text-gray-600 mt-2">
                    123 Learning Lane, Anytown
                  </p>
                </div>
              </div>
            </div>
