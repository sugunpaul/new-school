  ...
  return (
    <section id="home" className="relative pt-20 overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1472162072942-cd5147eb3902?auto=format&fit=crop&q=80&w=2069')",
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div
          className="absolute bottom-20 left-1/4 w-16 h-16 bg-preschool-light-coral rounded-full opacity-60 animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-40 right-1/4 w-24 h-24 bg-preschool-light-green rounded-full opacity-60 animate-bounce-light"
      ...
      <div className="section-container relative z-10">
        <div className="flex flex-col items-center gap-10 lg:gap-16 text-center">
          <div className="space-y-6 max-w-3xl mx-auto">
            <div
              className="inline-block px-4 py-1 rounded-full bg-preschool-light-blue text-preschool-blue text-sm font-medium mb-2 animate-fade-in"
            ...
            >
              Where Learning{" "}
              <span
                className="text-preschool-blue animate-fade-in-left"
                style={{ animationDelay: "0.5s", display: "inline-block" }}
              >
                Begins
              </span>{" "}
              With{" "}
              <span
                className="text-preschool-coral animate-fade-in-right"
                style={{ animationDelay: "0.7s", display: "inline-block" }}
              >
                Love
              </span>
            </h1>
            ...
            <p
              className="text-lg text-gray-600 max-w-xl mx-auto animate-fade-in"
            ...
            {/* New feature cards */}
            <div
              className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8 animate-fade-in"
            ...
            >
              <div className="bg-preschool-light-teal p-5 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105 flex gap-4 text-left">
                ...
                <div>
                  <h3 className="font-bold text-lg text-preschool-teal">
                    Child Safety
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Secure environment with trained staff and safety protocols.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-preschool-light-coral p-5 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105 flex gap-4 text-left">
                ...
                <div>
                  <h3 className="font-bold text-lg text-preschool-coral">
                    Loving Care
                  </h3>
                  <p className="text-gray-600 text-sm">
                    Nurturing educators dedicated to your child's development
                    and happiness.
                  </p>
                </div>
              </div>
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden">
        ...
        >
          <path
            d="M0 0L48 10C96 20 192 40 288 50C384 60 480 60 576 50C672 40 768 20 864 15C960 10 1056 20 1152 30C1248 40 1344 50 1392 55L1440 60V100H1392C1344 100 1248 100 1152 100C1056 100 960 100 864 100C768 100 672 100 576 100C480 100 384 100 288 100C192 100 96 100 48 100H0V0Z"
            fill="#F9FAFB"
          />
        </svg>
      </div>
